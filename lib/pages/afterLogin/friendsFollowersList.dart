...
class FriendsFollowersList extends CommonStatefulWidget {
  const FriendsFollowersList({required Key? key}) : super(key: key);

  @override
  _FriendsFollowersListState createState() => _FriendsFollowersListState();
}

class _FriendsFollowersListState extends State<FriendsFollowersList> {
  ...
  void onSegmentChanged(strVal) {
    ...
    segmentOnSelected = segmentOptions().indexOf(strVal);
    setState(() {});
  }

  List<String> segmentOptions() {
    return [
      waitingUsers.length.toString() + ' Followers',
      waitingUsers.length.toString() + ' Following'
    ];
  }
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      child: segment(
                          ...
                          segmentWidgetHeight,
                          segmentOptions(),
                          segmentOptions()[segmentOnSelected],
                          onSegmentChanged,
                          needBorder: false)),
                ),
                      ...
                      child: (waitingUsers.length > 0)
                          ? ListView(
                              ...
                              children:
                                ...
                                return followerRequestBlock(index,
                                    (onclickedIndex) {
                                  print('should push [' +
                                      onclickedIndex.toString() +
                                      '] user info');
...
Widget assetBlock(
  ...
  String dateMark = data.formatedDateOfBirth() + ' • ' + data.zodiac();
...
Widget followerRequestBlock(int idx, Function(int) onPress,
